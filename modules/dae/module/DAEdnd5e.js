...
import { applyDaeEffects, getSelfTarget, libWrapper, noDupDamageMacro } from "./dae.js";
...
function getRollData(wrapped) {
    ...
    if (this.isLinked) {
      const tokenDocument = getSelfTarget(this);
      data.tokenUuid = tokenDocument?.uuid;
      data.tokenId = tokenDocument.object.id
    }
    return data;
}

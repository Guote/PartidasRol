...
export class SettingsForm {
    ...
    static getFlavorNextToPortrait() {
        return game.settings.get(CONSTANTS.MODULE_NAME, 'flavorNextToPortrait');
    }
    ...
    static getDisplayMessageTagNextToName() {
        return game.settings.get(CONSTANTS.MODULE_NAME, 'displayMessageTagNextToName');
    }
    static setDisplayMessageTagNextToName(value) {
    ...
    static getApplyPreCreateChatMessagePatch() {
        return game.settings.get(CONSTANTS.MODULE_NAME, 'applyPreCreateChatMessagePatch');
    }
    static setApplyPreCreateChatMessagePatch(value) {

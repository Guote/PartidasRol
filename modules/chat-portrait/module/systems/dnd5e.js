...
export default {
    ...
    imageReplacerIconizer: [
        ...
        // dnd5e
        // =======================================================================
        { name: 'DND5E.DamageRoll', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/damage_roll.svg` },
        { name: 'DND5E.AttackRoll', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/attack_roll.svg` },
        { name: 'DND5E.AbilityStr', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/strength.svg` },
        { name: 'DND5E.AbilityDex', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/dexterity.svg` },
        { name: 'DND5E.AbilityCon', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/constitution.svg` },
        { name: 'DND5E.AbilityInt', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/intelligence.svg` },
        { name: 'DND5E.AbilityWis', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/wisdom.svg` },
        { name: 'DND5E.AbilityCha', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/charisma.svg` },
        { name: 'DND5E.Initiative', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/initiative.svg` },
        { name: 'DND5E.SkillAcr', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/acrobatics.svg` },
        { name: 'DND5E.SkillAni', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/animal_handling.svg` },
        { name: 'DND5E.SkillArc', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/arcana.svg` },
        { name: 'DND5E.SkillAth', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/athletics.svg` },
        { name: 'DND5E.SkillDec', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/deception.svg` },
        { name: 'DND5E.SkillHis', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/history.svg` },
        { name: 'DND5E.SkillIns', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/insight.svg` },
        { name: 'DND5E.SkillItm', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/intimidation.svg` },
        { name: 'DND5E.SkillInv', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/investigation.svg` },
        { name: 'DND5E.SkillMed', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/medicine.svg` },
        { name: 'DND5E.SkillNat', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/nature.svg` },
        { name: 'DND5E.SkillPrc', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/perception.svg` },
        { name: 'DND5E.SkillPrf', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/performance.svg` },
        { name: 'DND5E.SkillPer', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/persuasion.svg` },
        { name: 'DND5E.SkillRel', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/religion.svg` },
        { name: 'DND5E.SkillSlt', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/sleight_of_hand.svg` },
        { name: 'DND5E.SkillSte', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/stealth.svg` },
        { name: 'DND5E.SkillSur', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/survival.svg` },
        { name: 'DND5E.ToolArtisans', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/artisan_s_tools.svg` },
        { name: 'DND5E.ToolDisguiseKit', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/disguise_kit.svg` },
        { name: 'DND5E.ToolForgeryKit', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/forgery_kit` },
        { name: 'DND5E.ToolGamingSet', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/gaming_set.svg` },
        { name: 'DND5E.ToolHerbalismKit', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/herbalism_kit` },
        { name: 'DND5E.ToolMusicalInstrument', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/musical_instrument.svg` },
        { name: 'DND5E.ToolNavigators', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/navigator_s_tools.svg` },
        { name: 'DND5E.ToolPoisonersKit', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/poisoner_s_kit.svg` },
        { name: 'DND5E.ToolThieves', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/thieves_tools.svg` },
        { name: 'DND5E.ShortRest', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/short_rest.svg` },
        { name: 'DND5E.LongRest', icon: `/modules/${CONSTANTS.MODULE_NAME}/assets/long_rest.svg` },

...
class DataConverterItem extends DataConverter {
	...
	static async _pGetItemImporterType (item) {
		...
		if (item.containerCapacity) return DataConverterItem._IMPORT_TYPE_BACKPACK;
	...
	static async _pGetItemItem_notFromSrd (item, opts, entriesStr) {
		...
		switch (importType) {
			...
			case DataConverterItem._IMPORT_TYPE_BACKPACK: return this._pGetItemItem_container(item, opts, entriesStr);
	...
	static async _pGetItemItem_pGetAttunedIdentifiedEquipped (item, opts) {
		...
		switch (importType) {
			...
			case DataConverterItem._IMPORT_TYPE_BACKPACK: isEquipped = false; break;
...
DataConverterItem._IMPORT_TYPE_BACKPACK = "backpack";
...
DataConverterItem.VALID_FOUNDRY_ITEM_TYPES_IMPORT = [
	...
	DataConverterItem._IMPORT_TYPE_BACKPACK,
...
DataConverterItem._ITEM_TYPE_TO_ICON = {
	...
	SPC: "rocket-flight", // Vehicle (space)
	WD: "fairy-wand", // Wand
};

import { MODULE_ID, MyFlags } from "../constants.js";
...
const renderUnexploredImgControls = (app, html, data) => {
  ...
  <div class="form-group">
      ...
      <div class="form-fields">
          <button type="button" class="file-picker" data-type="imagevideo" data-target="flags.${MODULE_ID}.${MyFlags.UnexploredImg}" title="Browse Files" tabindex="-1">
              <i class="fas fa-file-import fa-fw"></i>
          </button>
          <input class="image" type="text" name="flags.${MODULE_ID}.${MyFlags.UnexploredImg}" value="${unexploredImg ? unexploredImg : ``}" placeholder="Unexplored Fog Background Image File Path" data-dtype="String" />
      </div>
  </div>

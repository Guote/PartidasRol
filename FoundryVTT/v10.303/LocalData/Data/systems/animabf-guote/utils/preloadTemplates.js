...
Templates.Dialog.Icons.Accept,
    ...
    `systems/${ABFSystemName}/templates/dialog/combat/chat-combat-defense/parts/accumulation.hbs`,
    ...
    `systems/${ABFSystemName}/templates/actor-v2/layout/card.hbs`,
    `systems/${ABFSystemName}/templates/actor-v2/layout/collapsible-section.hbs`,
    // V2 Components
    `systems/${ABFSystemName}/templates/actor-v2/components/stat-block.hbs`,
    `systems/${ABFSystemName}/templates/actor-v2/components/resource-bar.hbs`,
    ...
    `systems/${ABFSystemName}/templates/actor-v2/parts/header/core-resources.hbs`,
    ...
    `systems/${ABFSystemName}/templates/actor-v2/parts/tabs/skills.hbs`,
    `systems/${ABFSystemName}/templates/actor-v2/parts/tabs/bio.hbs`,
    `systems/${ABFSystemName}/templates/actor-v2/parts/tabs/inventory.hbs`,
    `systems/${ABFSystemName}/templates/actor-v2/parts/tabs/mystic.hbs`,

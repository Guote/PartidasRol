...
export default class NpcActorSheet extends ActorSheet {
  ...
  static get defaultOptions() {
    return {
      ...
      ...{
        ...
        template: `systems/${ABFSystemName}/templates/actor/npc-sheet.hbs`,
        /* width: 1000,
        height: 850, */
        submitOnChange: true,
        /* tabs: [
  ...
  get template() {
    return `systems/${ABFSystemName}/templates/actor/npc-sheet.hbs`;
  }
  async close(options) {
    super.close(options);
    this.position.width = this.getWidthDependingFromContent();

...
export class CardActionParametersBase {
    ...
    /**
     * Additional bindings for sheet
     */
    addListeners() {
        this.sheet.bindEvent(".parameters-panel .cancel", this.resumeAction);
    }
...
export class CardActionParametersForCardSelection extends CardActionParametersBase {
    ...
    _loadParametersWhileChoosingCards(parameters) {
        ...
        const availableCardsInfo = this.filteredCards.map(c => {
            const cardInfo = this.sheet.buildCardInfo(c);
    ...
    addListeners() {
        super.addListeners();
        this.sheet.bindEvent(".parameters-panel .stacks .stack", this.onClickChooseStack);
        this.sheet.bindEvent(".parameters-panel .cards .card-slot", this.onClickToggleSelection);
        this.sheet.bindEvent(".parameters-panel .change-stack", this.onClickChangeStack);
        this.sheet.bindEvent(".parameters-panel .selection-ok", this.onClickPerformAction);
    }
...
export class CardActionParametersForPlayerSelection extends CardActionParametersBase {
    ...
    addListeners() {
        super.addListeners();
        this.sheet.bindEvent(".parameters-stacks .stacks .stack", this.onClickToggleSelection);
        this.sheet.bindEvent(".parameters-stacks .amount-edit", this.onClickModifyAmount);
        this.sheet.bindEvent(".parameters-stacks .selection-ok", this.onClickPerformAction);
    }

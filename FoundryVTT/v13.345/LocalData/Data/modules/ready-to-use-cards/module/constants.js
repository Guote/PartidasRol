...
export const GlobalConfiguration = {
    ...
    version: "version",
    versionForUser: "versionForUser"
};

export const defaultShortcutSettings = (user) => {
    const settings = {
        hands: {
            displayed: true,
            scale: 0.1,
    ...
    settings.hands.byUsers[user.id] = defaultUIDataForHand();
    settings.revealed.byUsers[user.id] = defaultUIDataForRevealed();
    return settings;
}

export const defaultUIDataForHand = () => {
    return {
        displayed: true,
        left: 800,
        bottom: 110
...
export const defaultUIDataForRevealed = () => {
    return {
        displayed: true,
        left: 800,
        bottom: 8

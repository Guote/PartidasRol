...
export const migrateFromV1 = async () => {
    ...
    if( someDataInV1 ) {
        const templateLoader = await foundry.applications.handlebars.getTemplate('modules/ready-to-use-cards/resources/migrations/v1message.hbs');
...
export const migrateFromV1ForUser = async() => {
    return VERSION_KEYS.V2;
}

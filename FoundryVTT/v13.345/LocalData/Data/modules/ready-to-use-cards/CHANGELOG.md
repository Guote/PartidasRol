...
### Bugfix
- *ShortcutForRevealedCards* and *ShortcutForHand* fix (a `this.user` was missing).

## Release 1.14.2

### Bugfix
- *Shortcuts*/*Hand*/*Revealed stack* were throwing errors when trying to display cards outside RTUC system.

## Release 1.14.1

### Bugfix
- Sometimes, the hook named `updateCustomCardsContent` was triggered before `module.shortcuts` was initialized. Throwing errors in the console.
- Custom decks, added though `Include in Ready-To-Use-Cards decks` were having ownership problems.

## Release 1.14.0

### Features
- Allowing the display of other player cards through shortcuts

### Bugfix
- `module.json` had some invalid properties (which were ignored)

### Translation
- Added labels : `RTUCards.migration.fromV2.xxx`, `RTUCards.settings.config-shortcuts.stack.xxx`

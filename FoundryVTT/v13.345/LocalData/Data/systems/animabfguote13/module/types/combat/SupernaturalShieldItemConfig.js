...
import "../mystic/SpellItemConfig.js";
import { ABFItemConfigFactory } from "../ABFItemConfig.js";
const SupernaturalShieldItemConfig = ABFItemConfigFactory({
  ...
  onCreate: async (actor) => {
    ...
    if (tab === "mystic") {
      ...
      actor.setFlag(game.animabfguote13.id, "spellCastingOverride", override);

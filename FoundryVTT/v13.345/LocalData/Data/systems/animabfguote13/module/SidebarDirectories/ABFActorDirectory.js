import { read as readSync, utils } from "../../node_modules/xlsx/xlsx.js";
import { parseExcelToActor } from "../actor/utils/parseExcelToActor.js";
class ABFActorDirectory extends ActorDirectory {
  /**
    ...
    new Dialog(
      {
        ...
        content: await renderTemplate(
          "systems/animabfguote13/templates/dialog/import-data-from-excel.html",
          {
        ...
        buttons: {
          import: {
            ...
            callback: (html) => {
              ...
              this.readExcelData(file).then((excelRows) => parseExcelToActor(excelRows, document)).catch(() => {

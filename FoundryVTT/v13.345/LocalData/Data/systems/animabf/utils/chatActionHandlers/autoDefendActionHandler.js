...
async function autoDefendActionHandler(message, _html, ds) {
  try {
    ...
    const attackData = (typeof ds.attackData === "string" ? safeParseJSON(ds.attackData) : ds.attackData) ?? msg?.getFlag(game.animabf.id, "attackData") ?? msg?.flags?.animabf?.attackData ?? null;

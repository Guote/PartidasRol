...
const Migration11UpdatePsychicPowersStructuredData = {
  ...
  description: "Updates psychic powers to the new structured data format by copying the system data from the official compendium (animabf.psychic) while preserving custom description and effect texts. Ensures default structured fields exist per effect (damage, fatigue, shieldPoints, affectsInmaterial) and tries to parse them from effect text.",
  filterItems(item) {

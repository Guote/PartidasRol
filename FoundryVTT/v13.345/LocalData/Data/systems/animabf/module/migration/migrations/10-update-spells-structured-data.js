...
const Migration10UpdateSpellsStructuredData = {
  ...
  description: "Updates spells to the new structured data format by copying the system data from the official compendium (animabf.magic) while preserving custom descriptions. Ensures default structured fields exist (damage, area, resistanceEffect, shieldPoints).",
  filterItems(item) {

...
class ABFCombat extends Combat {
  ...
  _sortCombatants(combatantA, combatantB) {
    ...
    if (initiativeA < (combatantA?.actor?.system.characteristics.secondaries.initiative.final.value || 0))
      initiativeA -= 2e3;
    if (initiativeB < (combatantB?.actor?.system.characteristics.secondaries.initiative.final.value || 0))
      initiativeB -= 2e3;
    return initiativeB - initiativeA;
  }
}
export {
  ABFCombat as default
};

const Migration9FixKiSeals = {
  version: 9,
  title: "Fix ki seals data reference",
  description: "Ki seals were using IsActive.value non existing data reference. This migration will ensure ki seals use the intended data reference.",
  updateActor(actor) {
    let minorSeals = {

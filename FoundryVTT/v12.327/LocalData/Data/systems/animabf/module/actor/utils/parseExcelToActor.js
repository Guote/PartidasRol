...
const parseExcelToActor = async (excelData, actor) => {
  ...
  excelData.RF_final - conResistance;
  excelData.RE_final - conResistance;
  excelData.RV_final - conResistance;
  excelData.RM_final - podResistance;
  excelData.RP_final - volResistance;

const INITIAL_ACTOR_DATA = {
  ...
  secondaries: {
    guotecundariasuno: {
      acrobacias: { base: { value: 0 }, final: { value: 0 } },
      actuacion: { base: { value: 0 }, final: { value: 0 } },
      animas: { base: { value: 0 }, final: { value: 0 } },
      arcana: { base: { value: 0 }, final: { value: 0 } },
      atletismo: { base: { value: 0 }, final: { value: 0 } },
      engaño: { base: { value: 0 }, final: { value: 0 } },
      historia: { base: { value: 0 }, final: { value: 0 } },
      ingenieria: { base: { value: 0 }, final: { value: 0 } },
    },
    guotecundariasdos: {
      investigacion: { base: { value: 0 }, final: { value: 0 } },
      medicina: { base: { value: 0 }, final: { value: 0 } },
      naturaleza: { base: { value: 0 }, final: { value: 0 } },
      percepcion: { base: { value: 0 }, final: { value: 0 } },
      perspicacia: { base: { value: 0 }, final: { value: 0 } },

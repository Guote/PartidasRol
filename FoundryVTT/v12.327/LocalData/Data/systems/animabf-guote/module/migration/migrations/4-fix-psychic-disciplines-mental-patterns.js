const Migration4PsychicDisciplinesMentalPatterns = {
  version: 4,
  title: "Normalise Psychic Disciplines and Mental Patterns",
  description: 'Psychic Disciplines and Mental Patterns are going to be normalised to standard strings. Any unrecognised discipline or pattern will become "Unknown Discipline" or "Unknown Pattern".',
  async updateActor(actor) {
    ...
    for (const discipline of actor.system.psychic.psychicDisciplines) {
      ...
      const newName = dictionary[name.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "")] || "unknown";
